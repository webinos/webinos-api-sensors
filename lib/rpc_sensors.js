...
//        var params = par;
        ...
        if (impl == 'iot') {
	    //dilib = require(__dirname+'/../../webinos-driver-arduino/lib/driverInterface.js');
	    dilib = require("webinos-driver-arduino");
                        ...
                        if(serviceList[id].listenerActive == true) {
                            ...
                            for(var i=0; i<serviceList[id].sensorEventListeners.length; i++){
                                if(serviceList[id].sensorEventListeners[i][3] === "sensor"){
                                    ...
                                    var rpc = rpcH.createRPC(serviceList[id].sensorEventListeners[i][2], "onEvent", sensorEvent);
                                    rpcH.executeRPC(rpc);
                                }
                            }
                        }
